        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="alert alert-success" role="alert">
              ...
              @php
                // Set waktu buka link konfirmasi ke hari ini jam 21.00 WIB
                $confirmationLinkOpenTime = now()->setTimezone('Asia/Jakarta')->setTime(21, 0);
              ...
              @else
                <button class="btn btn-secondary mt-3" disabled>
                  Link Konfirmasi Akan Dibuka Pukul 21.00 WIB
                </button>
              @endif
            </div>
